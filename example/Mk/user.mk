...
.if exists(/usr/local/bin/emprint)
# scripts (CheckConfig is for root, PrintScreen for user, need to split later)
USER_FILES+=	${HOME}/bin/PrintScreen
${HOME}/bin/PrintScreen: user/PrintScreen ${HOME}/bin _text_file
.endif

USER_FILES+=	${HOME}/bin/CheckConfig
${HOME}/bin/CheckConfig: user/CheckConfig ${HOME}/bin _text_file
